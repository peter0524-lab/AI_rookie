...
python3 local_pii_ensemble_inference.py \
  --ensemble-dir .. \
  --device cpu \
  --text "홍길동 고객님의 연락처는 [PHONE_PLACEHOLDER] 입니다."
```
...
```json
{
  "entities": [
    ...
    {"form": "[PHONE_PLACEHOLDER]", "label": "QT_MOBILE", "begin": 14, "end": 27}
  ]
}
```
...
```json
{"id":"req-1","text":"홍길동 고객님의 연락처는 [PHONE_PLACEHOLDER] 입니다."}
...
```json
{"id":"req-1","entities":[{"form":"홍길동","label":"PS_NAME","begin":0,"end":3},{"form":"[PHONE_PLACEHOLDER]","label":"QT_MOBILE","begin":14,"end":27}]}
